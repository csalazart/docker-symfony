...
echo "./win.container-exec.sh route:debug "
echo
echo -n "Ejecutando: ${@} en ${PROJECT_NAME}_php_1 php //var/www/symfony/bin/console"
exec winpty docker exec -it "${PROJECT_NAME}_php_1 php //var/www/symfony/bin/console" $@
